package com.upscale.exchange;

import com.upscale.exchange.config.ApplicationProperties;
import com.upscale.exchange.config.DefaultProfileUtil;
...
public class ExchangeApp {
    ...
    public ExchangeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ExchangeApp.class);
